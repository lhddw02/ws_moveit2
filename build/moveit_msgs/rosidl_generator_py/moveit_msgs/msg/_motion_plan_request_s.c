...
bool moveit_msgs__msg__motion_plan_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // smoothness_level
    PyObject * field = PyObject_GetAttrString(_pymsg, "smoothness_level");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->smoothness_level = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * moveit_msgs__msg__motion_plan_request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // smoothness_level
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->smoothness_level);
    {
      int rc = PyObject_SetAttrString(_pymessage, "smoothness_level", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
