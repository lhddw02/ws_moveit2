...
def generate_launch_description():
    ...
    ##############################################################
    panda1_joint_state_publisher_cmd = Node( 
        package='joint_state_publisher', 
        executable='joint_state_publisher', 
        name='panda1_joint_state_publisher', 
        parameters=[os.path.join(get_package_share_directory('robot_description'), 'config', 'initial_positions.yaml')] 
    )
    ##############################################################
    ...
    ld.add_action(panda1_joint_state_publisher_cmd)
